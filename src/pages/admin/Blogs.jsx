          ...
          <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-6">
            <div className="bg-white w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-2xl shadow-2xl p-8 space-y-6">
              ...
              <div className="grid gap-4 text-sm">
                ...
                <Field label="Excerpt" value={selectedBlog.excerpt} />
                <Field
                  label="Status"
                  value={
                ...
                {selectedBlog.content && (
                  <div>
                    ...
                    <div className="p-4 rounded-xl bg-slate-50 border whitespace-pre-line text-slate-700 leading-relaxed max-h-60 overflow-y-auto">
                      {selectedBlog.content}
                    </div>
                  </div>
                )}
